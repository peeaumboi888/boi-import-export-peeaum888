...
const AGENT_TYPE = "customs";

export default function CustomsAssistantPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold">Customs Assistant</h1>
        <p className="text-muted-foreground">ถามคำถามเกี่ยวกับพิธีการศุลกากร</p>
      </div>

      <Card className="h-[calc(100vh-300px)]">
        <CardHeader>
          <CardTitle>🚢 แชทกับ Customs Assistant</CardTitle>
          <CardDescription>พิมพ์คำถามของคุณเกี่ยวกับศุลกากร</CardDescription>
        </CardHeader>
        <CardContent className="flex flex-col h-full">
          <div className="flex-1 overflow-y-auto space-y-4 mb-4 p-4 rounded-lg border bg-muted/50 min-h-[300px]">
            {messages.length === 0 && (
              <div className="flex items-center justify-center h-full text-muted-foreground">
                เริ่มต้นถามคำถามเกี่ยวกับศุลกากรได้เลย
              </div>
            )}
